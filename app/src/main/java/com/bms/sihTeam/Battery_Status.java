...
public class Battery_Status extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_battery__status);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        GraphView graph = (GraphView) findViewById(R.id.StatusOfHealth);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            startActivity(new Intent(Battery_Status.this, MainActivity.class));
        } else if (id == R.id.nav_battery) {
            Toast.makeText(this, "You are already on Battery Status Page!", Toast.LENGTH_SHORT).show();
